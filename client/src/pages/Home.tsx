  ...
  return (
    <main className="site-shell">
      ...
      <section className="section coverage-section reveal-on-scroll" id="coverage">
        <div className="container coverage-grid"><div><SectionLabel>05 / Data transparency</SectionLabel><h2>Trust is built into the way the data is shown.</h2><p>Every insight is grounded in a visible source trail. AARAMBHA makes freshness, reliability, and methodology part of the experience — so users can understand both the finding and its limits.</p><ArrowLink href="#explore">Read the methodology</ArrowLink></div><div className="coverage-card"><div className="coverage-card-head"><BrandMark compact /><Database size={18} /><span>Source register</span><span className="coverage-status"><span /> Current view</span></div><div className="source-row"><span className="source-icon"><Landmark size={15} /></span><span><b>MPLADS records</b><small>Allocations / works / sanctions</small></span><strong>Verified</strong></div><div className="source-row"><span className="source-icon"><GitBranch size={15} /></span><span><b>Procurement records</b><small>Tenders / awards / contracts</small></span><strong>Linked</strong></div><div className="source-row"><span className="source-icon"><Activity size={15} /></span><span><b>Execution signals</b><small>Progress / payment / completion</small></span><strong>Tracked</strong></div><div className="coverage-card-foot"><span>Last updated / illustrative</span><span>Methodology v0.9 <ArrowUpRight size={13} /></span></div></div></div>
      </section>

      <section className="section explore-section reveal-on-scroll" id="explore">
        <div className="container explore-inner"><div className="explore-mark"><BrandMark compact /></div><div><SectionLabel dark>06 / Next move</SectionLabel><h2>Make public data easier to question — and easier to trust.</h2><p>Explore how AARAMBHA can help your team move from raw records to earlier, evidence-backed oversight.</p></div><div className="explore-actions"><a href="#top" className="button button-paper">Explore the platform <ArrowUpRight size={16} /></a><a href="#coverage" className="text-action text-action-light">View data coverage <ArrowRight size={16} /></a></div></div>
      </section>

      <footer className="site-footer"><div className="container footer-main"><a className="brand-lockup" href="#top"><BrandMark /><span className="brand-wordmark"><strong>AARAMBHA</strong><small>MPLADS intelligence</small></span></a><p>Evidence-led monitoring for public works, procurement, and the people responsible for both.</p><div className="footer-links"><a href="#platform">Platform</a><a href="#engine">Intelligence engine</a><a href="#coverage">Data coverage</a><a href="#how-it-works">Methodology</a></div></div><div className="container footer-bottom"><span>© 2026 AARAMBHA / Concept product for civic intelligence.</span><span>No government affiliation claimed.</span></div></footer>
    </main>
  );
}
